...
const DEFAULT_ID = process.env.MALL_CLI_IPC || 'mall-cli'
...
const PROJECT_ID = process.env.MALL_CLI_PROJECT_ID

exports.IpcMessage = class IpcMessage {
    constructor(options = {}) {
