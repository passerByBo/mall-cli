...
const { exit } = require('@mall/cli-shared-utils/lib/exit')
const { error } = require('@mall/cli-shared-utils/lib/logger')
const { createSchema, validate } = require('@mall/cli-shared-utils/lib/validate')
